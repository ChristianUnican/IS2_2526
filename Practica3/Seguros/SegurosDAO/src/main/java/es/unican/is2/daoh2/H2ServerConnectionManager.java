    ...
    public static void cargaDatos() throws DataAccessException {
        try {
            ...
            try (Statement stm = con.createStatement()) {
                ...
                // Inicializa seguros
                stm.executeUpdate("INSERT INTO Seguros (matricula, fechaInicio, cobertura, potencia, cliente_FK) "
                        + "VALUES ('1111AAA', '2002-01-15', 'TERCEROS', 15, '11111111A')");
                stm.executeUpdate("INSERT INTO Seguros (matricula, fechaInicio, cobertura, potencia, conductorAdicional, cliente_FK) "
